...
const transformation = [ { width: 174, height: 174 } ]; 
											...
											<div className="product-item men">
												<div className="product discount product_filter">
													<div className="product_image">
														<IKImage path="/product_1.png" transformation={transformation}/>
													</div>
